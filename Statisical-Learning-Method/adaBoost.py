...
def test():
    ...
    data_mat, class_labels = load_data_set('F:/pytorchwork/Statistical-Learning-Method/data/horseColicTraining.txt')
    ...
    data_arr_test, label_arr_test = load_data_set("F:/pytorchwork/Statistical-Learning-Method/data/horseColicTest.txt")
