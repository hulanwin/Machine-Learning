...
if __name__ == '__main__':
    ...
    #依据现有训练集统计PI、A、B
    PI, A, B = trainParameter('F:/pytorchwork/Statistical-Learning-Method/data/HMMTrainSet.txt')

    #读取测试文章
    artical = loadArticle('F:/pytorchwork/Statistical-Learning-Method/data/testArtical.txt')
