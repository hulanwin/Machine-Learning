...
if __name__ == '__main__':
    ...
    trainData, trainLabel = loadData('F:/pytorchwork/Statistical-Learning-Method/data/mnist/mnist_train.csv')

    # 获取测试集及标签
    print('start read testSet')
    testData, testLabel = loadData('F:/pytorchwork/Statistical-Learning-Method/data/mnist/mnist_test.csv')
