...
if __name__ == "__main__":
    ...
    #获取训练集
    trainDataArr, trainLabelArr = loadData('F:/pytorchwork/Statistical-Learning-Method/data/mnist/mnist_train.csv')
    #获取测试集
    testDataArr, testLabelArr = loadData('F:/pytorchwork/Statistical-Learning-Method/data/mnist/mnist_test.csv')
    #计算测试集正确率
