...
if __name__ == '__main__':
    ...
    # 获取训练集
    trainDataList, trainLabelList = loadData('F:/pytorchwork/Statistical-Learning-Method/data/mnist/mnist_train.csv')
    # 获取测试集
    testDataList, testLabelList = loadData('F:/pytorchwork/Statistical-Learning-Method/data/mnist/mnist_test.csv')
